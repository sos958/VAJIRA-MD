...
global.owner = process.env.OWNER_NUMBER  || '94705533794' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=qBkTTZ6A#DRFblbED_TPdtAljdJDS2jJhsIbI9KEwDgTfI-ycPO0' ,
